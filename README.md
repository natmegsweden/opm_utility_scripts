...
rename_analog_channels.py renames analog input channels (and changes types) for, e.g., ECG, EOG, according to analog_channel_mapping.json (can be generated by generate_analog_channel_mapping.py)
